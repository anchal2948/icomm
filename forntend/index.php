...
<!-- Mirrored from htmlbeans.com/html/schon/homepage6.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Apr 2023 13:56:15 GMT -->
<head>
...
<body class="right-side">
	...
	<div id="wrapper">
		...
		<div class="w1">
			...
			<header id="mt-header" class="style18">
				<!-- mt top bar start here -->
				<div class="mt-top-bar">
					<div class="container">
						<div class="row">
							<div class="col-xs-12 col-sm-6 hidden-xs">
								<span class="tel"> <i class="fa fa-phone" aria-hidden="true"></i> +1 (555) 345 3461</span>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="mt-icon-list right">
									<li class="marginzero">
										<a href="#" class="bar-opener side-opener right">
											<span class="bar"></span>
								...
								</ul><!-- mt icon list start here -->
								<div class="mt-logo" style="width: 112px;"><a href="#"><img src="images/mt-logo.png" alt="schon"></a></div>
							</div>
						</div>
					</div>
			...
			</header><!-- mt header style18 end here -->
			
			
			<!-- mt mainslider3 start here -->
			<div class="mt-mainslider3">
				<!-- slider banner-slider start here -->
				<div class="slider banner-slider">
					<!-- holder start here -->
					<div class="holder">
						<img class="img" src="images/img-34.jpg" alt="image description">
					</div><!-- holder end here -->
					<!-- holder start here -->
					<div class="holder">
						<img class="img" src="images/img-46.jpg" alt="image description">
						<div class="txt-wrap">
							<span class="title">FURNITURE DESIGNS IDEAS</span>
					...
					<!-- holder start here -->
					<div class="holder">
						<img class="img" src="images/img-47.jpg" alt="image description">
						<div class="txt-wrap right">
							<span class="title">FURNITURE DESIGNS IDEAS</span>
							<h1>WOODEN</h1>
							<h2>COLLECTION</h2>
							<div class="txt">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="banner-frame">
								...
								<div class="banner-15 right wow fadeInLeft" data-wow-delay="0.4s">
									<img src="images/banner/img18.jpg" alt="image description">
									<div class="holder">
								...
								<!-- banner 15 start here -->
								<div class="banner-15 right wow fadeInRight" data-wow-delay="0.4s">
									<img src="images/banner/img17.jpg" alt="image description">
									<div class="holder">
								...
								<div id="mt-productscrollbar" class="row">
									...
									<div class="mt-holder">
										...
										<div class="mt-product1 large">
											<!-- box start here -->
											<div class="box">
												<img alt="image description" src="images/products/img22.jpg">
												<ul class="mt-stars">
										...
										<div class="mt-product1 large">
											<!-- box start here -->
											<div class="box">
												<img alt="image description" src="images/products/img23.jpg">
												<ul class="links">
													<li><a href="#"><i class="icon-handbag"></i></a></li>
													<li><a href="#"><i class="icon-heart"></i></a></li>
													<li><a href="#popup1" class="lightbox"><i class="icomoon icon-eye"></i></a></li>
										...
										<div class="mt-product1 large">
											<!-- box start here -->
											<div class="box">
												<img alt="image description" src="images/products/img24.jpg">
												<span class="caption">
							...
							<div class="banner-frame nospace wow fadeInUp" data-wow-delay="0.4s">
								<!-- banner 9 start here -->
								<div class="banner-9">
									<img alt="image description" src="images/banner/img20.jpg">
									<div class="holder">
								...
								<div class="banner-10">
									<img alt="image description" src="images/banner/img21.jpg">
									<div class="holder">
								...
								<div class="banner-11">
									<img alt="image description" src="images/banner/img19.jpg">
									<div class="holder">
								...
								<div class="row">
									<div class="col-xs-12 col-sm-6 col-md-3 mt-paddingbottomsm">
										...
										<div class="mt-product4 mt-paddingbottom20">
											<div class="img">
												<a href="product-detail.html"><img src="images/products/img14.jpg" alt="image description"></a>
											</div>
											<div class="text">
												<div class="frame">
										...
										<div class="mt-product4 mt-paddingbottom20">
											<div class="img">
												<a href="product-detail.html"><img src="images/products/img15.jpg" alt="image description"></a>
											</div>
											<div class="text">
												<div class="frame">
										...
										<div class="mt-product4 mt-paddingbottom20">
											<div class="img">
												<a href="product-detail.html"><img src="images/products/img16.jpg" alt="image description"></a>
											</div>
											<div class="text">
												<div class="frame">
									...
									<div class="col-xs-12 col-sm-6 col-md-3 mt-paddingbottomsm">
										...
										<div class="mt-product4 mt-paddingbottom20">
											<div class="img">
												<a href="product-detail.html"><img src="images/products/img17.jpg" alt="image description"></a>
											</div>
											<div class="text">
												<div class="frame">
										...
										<div class="mt-product4 mt-paddingbottom20">
											<div class="img">
												<a href="product-detail.html"><img src="images/products/img18.jpg" alt="image description"></a>
											</div>
											<div class="text">
												<div class="frame">
													<strong><a href="product-detail.html">Oyo Cantilever Chair</a></strong>
										...
										<div class="mt-product4 mt-paddingbottom20">
											<div class="img">
												<a href="product-detail.html"><img src="images/products/img19.jpg" alt="image description"></a>
											</div>
											<div class="text">
												<div class="frame">
									...
									<div class="col-xs-12 col-sm-6 col-md-3 mt-paddingbottomxs">
										...
										<div class="mt-product4 mt-paddingbottom20">
											<div class="img">
												<a href="product-detail.html"><img src="images/products/img20.jpg" alt="image description"></a>
											</div>
											<div class="text">
												<div class="frame">
										...
										<div class="mt-product4 mt-paddingbottom20">
											<div class="img">
												<a href="product-detail.html"><img src="images/products/img21.jpg" alt="image description"></a>
											</div>
											<div class="text">
												<div class="frame">
													<strong><a href="product-detail.html">Oyo Cantilever Chair</a></strong>
