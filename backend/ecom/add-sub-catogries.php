        ...
        <div class="white_card_header">
          <div class="box_header m-0">
            <div class="main-title">
              <h3 class="m-0">Fill All Categories</h3>
            </div>
          </div>
        </div>
            ...
            <form action="function.php" method="post">
              <div class="row mb-6">
                <div class="col-md-6 mb-3">
                  <label class="form-label" for="inputEmail4">Parent Categories</label>
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="name" class="form-control" name="subCategories" id="subCategories" placeholder="name">
                </div>


                <div class="col-md-6 mb-3">
                  <label class="form-label" for="inputEmail4">Meta KEyword</label>
                  <input type="name" class="form-control" name="Meta_KEyword" id="name" placeholder="name">
                </div>


                <div class="col-md-6 mb-3">
                  <label class="form-label" for="inputEmail4">Meta Discription</label>
                  <input type="name" class="form-control" name="Meta_Discription" id="name" placeholder="name">
                </div>
