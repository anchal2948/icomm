        ...
        <div class="container-fluid p-0 sm_padding_15px">
          <div class="row justify-content-center">
                  ...
                  <div class="QA_section">
                    <div class="white_box_tittle list_header">
                      <h4>Table</h4>
                        ...
                        <div class="add_button ms-2 " a href="add-categories.php">
                          <a href="add-categories.php" data-bs-toggle="modal" data-bs-target="add-categories.php" class="btn_1">Add New</a>
                        </div>
                      </div>
                    </div>
            ...
            <table class="table lms_table_active ">
                        <thead>
                          <tr>
                            <th scope="col"><b>Sub Category id</b></th>
                            <th scope="col"><b>Sub Category Name</b></th>
                            <th scope="col"><b>Slug_Url</b></th>
                            <th scope="col"><b>Category Name</b></th>
                            <th scope="col"><b>status</b></th>
                            <th scope="col"><b>added_on</b></th>
